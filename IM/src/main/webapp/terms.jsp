                ...
                <div class="section-top-border">
                    <div class="row justify-content-md-center">
                        <div class="en section_container active" section-language="en">
                            <div id="md_en" data-target="out_en" class="agreement_md"><h1>Terms of service</h1>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Medical.</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <p><strong>Website</strong> refers to Medical, accessible from <a href="medical.kz" rel="external nofollow noopener" target="_blank">medical.kz</a></p>
                                    </li>
                                    <li>
